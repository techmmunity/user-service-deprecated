...
export class AddConfirmationTokenTable1619739645119
	implements MigrationInterface {
	public name = "AddConfirmationTokenTable1619739645119";

	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`CREATE TABLE "confirmation_tokens" ("id" character varying(36) NOT NULL, "user_id" character varying(36) NOT NULL, "type" character varying NOT NULL, "token" character varying(6) NOT NULL, "used_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e48a0124b300b3b1e14d8b7baa4" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
